...
if __name__ == '__main__':
    # run_eval()
    train()
    # TODO figure out why fitness from makeLastTraj doesn't match that from traj_runner
    # TODO implement/fix post-capture maneuver
    # TODO verify that traj_runner and neat_main provide the same output/do the same thing
    ...
    # ---- at this point code is fully verified and I will be caught up to where I was; now, move forward
